...
const SERVICE_LABELS: Record<string, string> = {
  ...
  catalog_worker: 'Worker Catalog (creación productos canónicos)',
}
            ...
            <div style={{ flex: 1 }}>
              <details>
                ...
                <button className="btn" style={{ marginLeft: 8 }} onClick={async () => {
                  ...
                  } catch (e: any) { alert(e?.response?.data?.detail || 'Fallo al validar deps') }
                }}>Validar deps</button>
                <button className="btn" style={{ marginLeft: 8 }} onClick={async () => {
                  try {
                  ...
                  } catch (e: any) { alert(e?.response?.data?.detail || 'Fallo al instalar deps') }
                }}>Instalar deps</button>
              </details>
