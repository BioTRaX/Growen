@echo off
REM NG-HEADER: Nombre de archivo: start_worker_market.cmd
REM NG-HEADER: Ubicación: scripts/start_worker_market.cmd
REM NG-HEADER: Descripción: Script para iniciar el worker de Market con hot-reload (watchmedo)
