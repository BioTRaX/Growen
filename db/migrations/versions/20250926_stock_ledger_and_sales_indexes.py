...
def upgrade() -> None:
    ...
    # Unique en document_number ignorando NULL: usar índice parcial (PostgreSQL). Si no es Postgres, fallback validación app.
    bind = op.get_bind()
    ...
    if dialect == 'postgresql':
        ...
        # Para otros motores (sqlite) no soporta índice parcial; crear índice normal y asumir app-level uniqueness evitando duplicados no nulos.
        # Evitar constraint duro que bloquee múltiples NULL.
