...
<!-- NG-HEADER: Ubicación: docs/features/DRIVE_SYNC_DRAMATIQ.md -->
...
- `docs/features/GOOGLE_DRIVE_SETUP.md`: Configuración inicial de Google Drive
- `docs/features/GOOGLE_DRIVE_SYNC.md`: Documentación general de sincronización
