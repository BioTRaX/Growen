...
<!-- NG-HEADER: Ubicación: docs/features/MERCADO.md -->
...
- `docs/features/MERCADO_FILTROS.md` - Sistema de filtros avanzado
- `docs/features/MERCADO_EDICION_PRECIOS.md` - Guía de edición de precios (nueva funcionalidad)
- `docs/features/MERCADO_INTEGRACION_FRONTEND.md` - Integración frontend-backend (GET /market/products)
- `docs/features/MERCADO_SOURCES_ENDPOINT.md` - Endpoint GET /market/products/{id}/sources (nueva funcionalidad)
- `docs/features/API_MARKET.md` - Documentación de API del módulo Mercado
...
- **Etapa 1**: ✅ Completada (Componente de tabla UI - 2025-11-11)
  ...
  - **Documentación detallada** en `docs/features/MERCADO_FILTROS.md`
- **Etapa 2**: 🔄 En Progreso (Modelo de datos y endpoints backend)
  - ✅ **Endpoint `GET /market/products`** implementado (2025-11-11):
    ...
    - Documentación en `docs/features/API_MARKET.md`
...
### Documentación
- `docs/features/MERCADO.md` - Plan completo de implementación (este archivo)
- `docs/MERCADO_IMPLEMENTACION.md` - Detalles técnicos de implementación
- `docs/features/MERCADO_FILTROS.md` - Guía detallada del sistema de filtros
- `docs/features/MERCADO_FILTROS_CHANGELOG.md` - Changelog de mejoras de filtros
- `docs/features/MERCADO_EDICION_PRECIOS.md` - Guía de edición de precios
- **`docs/features/API_MARKET.md`** - Documentación de API del módulo Mercado (nuevo - 2025-11-11)
- **`docs/features/MERCADO_INTEGRACION_FRONTEND.md`** - Integración frontend-backend GET /market/products (nuevo - 2025-11-11)
