...
<!-- NG-HEADER: Ubicación: docs/features/SALES.md -->
...
Los adjuntos viven bajo `PRIVATE_MEDIA_ROOT/sales` y ya no exponen su ruta de
disco en respuestas. `GET /sales/{sale_id}/attachments/{attachment_id}/file`
requiere sesión, valida rol y pertenencia y responde `404` de forma uniforme.
El árbol privado no se monta en `/media/*`.
