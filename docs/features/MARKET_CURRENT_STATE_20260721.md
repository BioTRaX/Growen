...
<!-- NG-HEADER: Ubicación: docs/features/MARKET_CURRENT_STATE_20260721.md -->
...
> **Baseline histórico.** Este relevamiento conserva el estado previo y la secuencia de decisiones del 2026-07-21. No debe usarse como fuente del runtime vigente: `/mercado` está `active/vue`. Consultar `docs/features/API_MARKET.md` para el contrato actual y `docs/development/FRONTEND_MIGRATION_VUE.md` para el estado de migración.
