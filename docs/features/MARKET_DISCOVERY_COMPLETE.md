...
<!-- NG-HEADER: Ubicación: docs/features/MARKET_DISCOVERY_COMPLETE.md -->
...
| Archivo | Descripción |
|---------|-------------|
| `docs/features/MARKET_QUERY_OPTIMIZATION.md` | Optimización de queries |
| `docs/features/MCP_DIAGNOSTICS.md` | Diagnóstico conectividad MCP |
| `docs/features/MARKET_DISCOVERY_COMPLETE.md` | Este documento |
...
- **MCP Web Search**: `docs/architecture/MCP.md`
- **API Market**: `docs/features/API_MARKET.md`
- **Migraciones**: `docs/features/MIGRATIONS_NOTES.md`
- **Arquitectura Chat**: `docs/architecture/CHATBOT_ARCHITECTURE.md`
