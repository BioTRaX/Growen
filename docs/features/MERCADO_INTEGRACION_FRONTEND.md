...
<!-- NG-HEADER: Ubicación: docs/features/MERCADO_INTEGRACION_FRONTEND.md -->
...
> **Documento histórico.** Describe el baseline React de 2025 y no representa el runtime actual. `/mercado` está activo en Vue; consultar `docs/features/API_MARKET.md` para el contrato vigente y `docs/development/FRONTEND_MIGRATION_VUE.md` para el estado de migración. No agregar aquí cambios funcionales nuevos.
...
**Cobertura**: 12 test cases (ver `docs/features/API_MARKET.md` sección Tests)
...
- **Documentación API**: `docs/features/API_MARKET.md`
- **Plan maestro**: `docs/features/MERCADO.md`
