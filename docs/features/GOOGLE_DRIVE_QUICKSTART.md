...
<!-- NG-HEADER: Ubicación: docs/features/GOOGLE_DRIVE_QUICKSTART.md -->
...
4. Ver guía completa en `docs/features/GOOGLE_DRIVE_SETUP.md`
...
- `docs/features/GOOGLE_DRIVE_SETUP.md` - Configuración inicial completa
- `docs/features/GOOGLE_DRIVE_SYNC.md` - Documentación técnica detallada
