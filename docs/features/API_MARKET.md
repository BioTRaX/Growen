...
<!-- NG-HEADER: Ubicación: docs/features/API_MARKET.md -->
...
Este archivo es la fuente canónica para API, reglas operativas y ejecución de Mercado. `docs/features/MERCADO_INTEGRACION_FRONTEND.md` conserva únicamente el baseline React de 2025; los documentos `MARKET_CURRENT_STATE_*` y `RETROSPECTIVE_MARKET_*` son evidencia histórica, no fuentes del estado vigente.
...
**Suite completa de tests**: Ver `docs/features/MARKET_UNIT_TESTS.md` para documentación detallada.
...
- `docs/features/MERCADO.md` - Plan maestro de implementación
- `docs/MERCADO_IMPLEMENTACION.md` - Detalles técnicos
- `docs/features/MERCADO_EDICION_PRECIOS.md` - Funcionalidad de edición de precios
- `docs/features/MARKET_UNIT_TESTS.md` - **NUEVO**: Documentación completa de tests unitarios
- `docs/features/API_PRODUCTS.md` - Endpoints generales de productos
