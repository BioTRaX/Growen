...
<!-- NG-HEADER: Ubicación: docs/features/MERCADO_SOURCES_ENDPOINT.md -->
...
- Documentación en `docs/features/API_MARKET.md` y este documento
...
- `docs/features/API_MARKET.md` - Documentación completa de API
- `docs/features/MERCADO.md` - Plan maestro de implementación
- `docs/features/MERCADO_INTEGRACION_FRONTEND.md` - Guía de integración frontend-backend
