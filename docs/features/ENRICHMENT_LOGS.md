...
<!-- NG-HEADER: Ubicación: docs/features/ENRICHMENT_LOGS.md -->
...
real: `docs/features/ENRICH_V2_DEPLOYMENT_SMOKE_20260725.md`.
...
- [ ] Publicar en SiYuan un resumen curado de enriquecimientos con error recurrente
...
- Documentación de API: `docs/features/API_PRODUCTS.md` (sección "POST /products/{id}/enrich" y "GET /debug/enrich/{id}")
