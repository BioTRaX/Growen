...
<!-- NG-HEADER: Ubicación: docs/features/dependencies.md -->
...
### Ollama (LLM local)
Ver `docs/features/ollama.md` para instalación, variables de entorno y pruebas de conectividad. Si `AI_ALLOW_EXTERNAL=false` el router usará Ollama para todas las tareas soportadas.
