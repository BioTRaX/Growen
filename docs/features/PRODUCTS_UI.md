...
<!-- NG-HEADER: Ubicación: docs/features/PRODUCTS_UI.md -->
...
- Stock: rutas `/stock` y `/stock/shortages` activas en Vue; contrato operativo en `docs/features/STOCK.md`.
...
Las capacidades pendientes deben consultarse en el manifiesto y en `docs/development/FRONTEND_MIGRATION_VUE.md`. Este documento no mantiene un segundo estado de migración. Enriquecimiento masivo, completar precios y catálogos están disponibles en Vue.
...
Stock reutiliza el precio efectivo canónico → proveedor y los contratos de producto, pero mantiene su documentación funcional y de exportaciones en `docs/features/STOCK.md`. Esta separación evita duplicar reglas entre Productos y Stock.
...
- La configuración completa, el despliegue y el smoke vigente están documentados en `docs/features/ENRICH_V2_DEPLOYMENT_SMOKE_20260725.md`.
