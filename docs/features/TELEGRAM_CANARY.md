...
<!-- NG-HEADER: Ubicación: docs/features/TELEGRAM_CANARY.md -->
...
- `docs/operations/CHAT_DEPLOYMENT.md`: preflight, servicios, fases y rollback.
- `docs/architecture/CHATBOT_ARCHITECTURE.md`: pipeline multicanal e identidad.
- `docs/operations/SECURITY.md`: roles y techo de Telegram.
- `docs/operations/SECURITY.md`: secretos, HMAC, privacidad y logs.
- `docs/architecture/CHAT.md`: contratos HTTP, WebSocket y Telegram.
- `docs/features/MIGRATIONS_NOTES.md`: estado de la revisión de rollout.
