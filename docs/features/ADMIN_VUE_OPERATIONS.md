...
<!-- NG-HEADER: Ubicación: docs/features/ADMIN_VUE_OPERATIONS.md -->
...
- Logs: Servicios previsualiza y elimina archivos físicos y carpetas dev antiguas; Workers elimina sólo `ServiceLog` y la acción de Imágenes elimina `ImageJobLog`, NDJSON y snapshots. Ver `docs/operations/LOG_CLEANUP.md`.
