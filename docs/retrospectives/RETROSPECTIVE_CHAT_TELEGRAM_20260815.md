...
<!-- NG-HEADER: Ubicación: docs/retrospectives/RETROSPECTIVE_CHAT_TELEGRAM_20260815.md -->
...
- La purga de refs históricas del incidente Telegram fue confirmada como
  finalizada. La protección automática de secretos continúa como control
  preventivo general, no como deuda abierta de ese incidente.
