...
<!-- NG-HEADER: Ubicación: docs/retrospectives/RETROSPECTIVE_REPOSITORY_PUBLICATION_20260721.md -->
...
- `docs/development/TESTING.md`, `docs/operations/SECURITY.md` y `docs/development/DEVELOPMENT_WORKFLOW.md`: alinean el flujo canónico con los incidentes resueltos.
