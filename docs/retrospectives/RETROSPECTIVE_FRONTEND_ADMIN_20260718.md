...
<!-- NG-HEADER: Ubicación: docs/retrospectives/RETROSPECTIVE_FRONTEND_ADMIN_20260718.md -->
...
- Relevamiento funcional, de rutas, acciones, roles y endpoints en `docs/features/relevamiento_admin.md`.
...
`docs/development/FRONTEND_MIGRATION_VUE.md` conservaba el baseline anterior de 43 unitarias y 2 E2E. Se actualizó a 54 unitarias en 19 archivos y 5 E2E. Este hallazgo confirma que las cifras de pruebas deben actualizarse en el mismo cambio que amplía el quality gate.
...
3. Elegir un único plugin pendiente y contrastar React, router backend, `docs/features/relevamiento_admin.md` y `docs/features/roles-endpoints.md`.
