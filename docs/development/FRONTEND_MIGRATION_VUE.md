...
<!-- NG-HEADER: Ubicación: docs/development/FRONTEND_MIGRATION_VUE.md -->
...
React conserva compatibilidad temporal para rollback. Su retiro sigue pendiente de smoke visual autenticado y una ventana estable. El contrato vigente está en `docs/features/API_MARKET.md`; `docs/features/MERCADO_INTEGRACION_FRONTEND.md` describe únicamente la integración React histórica.
...
React sólo podrá retirarse luego de dos releases estables y siete días sin incidentes críticos. Ver `docs/features/ADMIN_VUE_OPERATIONS.md` para smoke y rollback.
...
- El baseline exhaustivo de rutas, roles, inputs, acciones, endpoints y mapeo Plugin-based UI está en `docs/features/relevamiento_admin.md`; debe usarse como checklist de paridad funcional.
...
La operación detallada está en `docs/development/FRONTEND_MIGRATION_OPERATIONS.md`.
