...
<!-- NG-HEADER: Ubicación: docs/architecture/MARKET_SCHEDULER.md -->
...
- **Documentación relacionada:**
  - `docs/features/API_MARKET.md` - Endpoints de mercado
  - `docs/features/PERFORMANCE_TESTS.md` - Tests de performance
