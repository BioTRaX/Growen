...
<!-- NG-HEADER: Ubicación: docs/architecture/MARKET_AUTO_DISCOVERY.md -->
...
- `docs/features/API_MARKET.md` - Endpoints completos con ejemplos
- `docs/architecture/MCP.md` - Arquitectura de MCP Servers
