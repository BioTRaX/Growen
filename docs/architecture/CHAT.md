...
<!-- NG-HEADER: Ubicacion: docs/architecture/CHAT.md -->
...
y el worker polling fueron verificados. Ver `docs/operations/CHAT_DEPLOYMENT.md`.
...
- `docs/architecture/CHATBOT_ARCHITECTURE.md`: Arquitectura completa
