...
<!-- NG-HEADER: Ubicación: docs/architecture/CHATBOT_ARCHITECTURE.md -->
...
- `docs/architecture/CHAT.md`: Documentación de intents y memoria
- `docs/architecture/RAG.md`: Sistema de Knowledge Base
