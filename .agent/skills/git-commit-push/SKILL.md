...
description: Gestiona el versionado de cambios. Analiza modificaciones locales, VERIFICA que la documentación esté sincronizada con el código, genera commits semánticos detallados y realiza el push.
---
