...
# NG-HEADER: Descripción: Cliente HTTP para comunicarse con la API de Tiendanube.
# NG-HEADER: Lineamientos: Ver AGENTS.md
"""Cliente simulado de Tiendanube para pruebas (lista productos, actualiza stock)."""
